...
export function AceptacionClausula({
  ...
  return (
    <div className="mt-2">
      <div
        className="rounded-xl border border-gray-200 bg-gray-50 p-4 text-xs leading-relaxed mb-3"
        style={{ color: '#555' }}
      >
