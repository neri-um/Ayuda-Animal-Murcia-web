        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              <a
                href="https://www.instagram.com/ayudaanimalmurcia"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/ayudaanimalmurcia"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: '#f7e3b0' }}>
              Explora
            </h3>
          ...
          <div>
            ...
            <p className="text-xs mt-4 leading-relaxed" style={{ color: '#727272' }}>
              Asociación inscrita en el Registro de Asociaciones de la Región
              de Murcia. CIF: G-XXXXXXXX
            </p>
          </div>
        </div>
      </div>
...
export default function PublicLayout() {
  ...
  const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    `text-sm font-medium transition-colors hover:text-[#f7e3b0] ${
      isActive ? 'text-[#f7e3b0]' : 'text-slate-300'
    }`;

  const navLinkClassMobile = ({ isActive }: { isActive: boolean }) =>
    `block text-sm font-medium ${
      isActive ? 'text-[#f7e3b0]' : 'text-slate-600'
    }`;
  ...
  return (
    <div className="w-full min-h-screen flex flex-col" style={{ backgroundColor: '#f7f7f7' }}>
      ...
      <header
        ...
        style={{ backgroundColor: '#2e2e2e', borderColor: '#3f3f3f' }}
      >
