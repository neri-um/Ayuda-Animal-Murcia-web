...
import { Menu, X, LogIn, LayoutDashboard, LogOut, Instagram, Facebook, MapPin, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <a href="https://www.tiktok.com/@ayuda_animal_murcia" target="_blank" rel="noopener noreferrer"
                aria-label="TikTok de Ayuda Animal Murcia"
                className="rounded-full p-2 transition-colors hover:bg-white/10"
                style={{ border: '1px solid #727272' }}>
                <TikTokIcon className="w-4 h-4" style={{ color: '#d9d9d9' }} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                <WhatsAppIcon className="w-4 h-4 flex-shrink-0" style={{ color: '#727272' }} />
                <a href="https://wa.me/34722196933" className="transition-colors hover:text-white" style={{ color: '#727272' }}>+34 722 196 933</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-xs mt-4 leading-relaxed" style={{ color: '#727272' }}>
              Asociación inscrita en el Registro de Asociaciones de la Región de Murcia. CIF: G73418873
            </p>
          </div>
        </div>
      </div>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b" style={{ backgroundColor: '#2e2e2e', borderColor: '#3f3f3f' }}>
        ...
        {menuOpen && (
          <div className="md:hidden border-t bg-white px-4 py-4 space-y-3" style={{ borderColor: '#d9d9d9' }}>
            ...
            <NavLink to="/blog" className={navLinkClassMobile} onClick={() => setMenuOpen(false)}>Blog</NavLink>
