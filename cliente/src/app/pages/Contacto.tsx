...
import {
  Mail, MapPin, Clock, Heart, PawPrint,
  Send, CheckCircle2, ArrowRight, AlertCircle, MailPlus
} from 'lucide-react';
import { usePageMeta } from '../hooks/usePageMeta';
import TikTokIcon from '../components/TikTokIcon';
import WhatsAppIcon from '../components/WhatsAppIcon';

// El endpoint público POST /vidanimal/contacto envía el correo con Resend.
...
const CONTACT_INFO = [
  {
    icon: WhatsAppIcon,
    label: 'WhatsApp',
    value: '+34 722 19 69 33',
    sub: 'Lun–Vie 9:00–18:00',
    href: 'https://wa.me/34722196933',
  },
  {
    icon: Mail,
...
const FAQS = [
  {
    q: '¿Podemos ir a visitaros?',
    a: 'No tenemos refugio: funcionamos con casas de acogida. Eso sí, algunos de nuestros animales se encuentran en la gatera Cat Café y puedes ir a visitarlos.',
  },
  {
    q: '¿Cómo puedo adoptar?',
    a: 'Para adoptar con nosotros debes rellenar el formulario de adopción en nuestra página web. Nos pondremos en contacto contigo por WhatsApp cuando le echemos un vistazo.',
  },
  {
    q: '¿Puedo deducir mis aportaciones en la renta?',
    a: 'Sí. Como asociación sin ánimo de lucro acogida a la Ley 49/2002, tus donaciones son deducibles en la declaración de la renta. Si tienes alguna duda, escríbenos y te lo explicamos.',
  },
  {
  ...
  },
  {
    ...
    a: 'Contacta con nosotros antes de tomar ninguna decisión. Siempre intentaremos buscar una solución juntos o te ayudamos a difundir.',
  },
];
...
export default function Contacto() {
  ...
  usePageMeta({
    title: 'Contacto | Ayuda Animal Murcia',
    description: 'Contacta con Ayuda Animal Murcia: adopciones, apadrinamientos, voluntariado y ayuda con animales abandonados.',
    path: '/contacto',
  });
            ...
            <div>
              ...
              <div className="p-6 rounded-2xl" style={{ backgroundColor: '#faf7f0' }}>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://www.facebook.com/ayudanimalmurcia"
                    target="_blank" rel="noopener noreferrer"
                    className="px-4 py-2 rounded-full text-xs border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 transition-colors"
                    style={{ fontWeight: 500 }}
                  >
                    Facebook
                  </a>
                  <a
                    href="https://www.instagram.com/ayuda_animal_murcia"
                    target="_blank" rel="noopener noreferrer"
                    className="px-4 py-2 rounded-full text-xs border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 transition-colors"
                    style={{ fontWeight: 500 }}
                  >
                  ...
                  <a
                    href="https://www.tiktok.com/@ayuda_animal_murcia"
                    target="_blank" rel="noopener noreferrer"
                    className="px-4 py-2 rounded-full text-xs border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 transition-colors"
                    style={{ fontWeight: 500 }}
                  >
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h4 className="text-gray-900 mb-3 text-sm flex items-center gap-2" style={{ fontWeight: 600 }}>
                    <MailPlus className="w-4 h-4" style={{ color: '#2e2e2e' }} />
                    Únete a nuestra newsletter
                  </h4>
                  <a
                    href="https://b67467ba.sibforms.com/v2/serve/MUIFAIqstE8wben05oF4hpnr-ZU0JaHLubFkolCUtxcRG27gjbB0-EnOoQKnjm5te3m_8CBgsrW0fs9PyiXnskditbBHisJNtRfi4BXaY1ZxxIIdjCQ_Kyyy1F0jEINn1L-pyy4kw4yDlsFMi1Jf3HPCgTJr0sL_AXpkIFbEV1mezZrQ3bTRu_0fA_NfqFH6dBYFufp7GzTurHjVwg=="
                    target="_blank" rel="noopener noreferrer"
                    className="px-4 py-2 rounded-full text-xs border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 transition-colors"
                    style={{ fontWeight: 500 }}
                  >
