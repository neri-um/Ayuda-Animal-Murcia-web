    ...
    <div>
      ...
      <section className="relative py-24 text-white overflow-hidden" style={{ backgroundColor: '#213448' }}>
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <PawPrint className="absolute text-white/5" style={{ width: '20rem', height: '20rem', top: '-2rem', right: '-2rem', transform: 'rotate(20deg)' }} />
          <PawPrint className="absolute text-white/4" style={{ width: '10rem', height: '10rem', bottom: '2rem', left: '-1rem', transform: 'rotate(-15deg)' }} />
        </div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-white mb-6" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 700, lineHeight: 1.2 }}>
            Llevamos {stats.years} años dando<br />
            <span style={{ color: '#94B4C1' }}>segundas oportunidades</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              const Icon = s.icon;
              return (
                <div key={i} className="text-center p-6 rounded-2xl border border-gray-100 shadow-sm" style={{ backgroundColor: '#f8fbfc' }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3" style={{ backgroundColor: '#dce8ed' }}>
                    <Icon className="w-6 h-6" style={{ color: '#547792' }} />
                  </div>
                  <div style={{ fontSize: '1.8rem', fontWeight: 700, color: '#213448' }}>{s.value}</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm mb-4" style={{ backgroundColor: '#dce8ed', color: '#213448' }}>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-gray-700">
                    <CheckCircle2 className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#547792' }} />
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VALUES.map((v, i) => {
              const Icon = v.icon;
              return (
                <div key={i} className="p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow" style={{ backgroundColor: '#fafafa' }}>
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4" style={{ backgroundColor: '#dce8ed' }}>
      ...
      {/* Equipo */}
      <section className="py-20" style={{ backgroundColor: '#EAE0CF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-gray-900 mb-2">¿Quién hay detrás?</h2>
            <p className="text-gray-500 text-sm max-w-md mx-auto">Un equipo de personas que dedica su tiempo libre a mejorar la vida de los animales</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-14">
            {TEAM_ROLES.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 text-center shadow-sm border border-white">
          ...
          {/* Voluntariado CTA */}
          <div className="max-w-3xl mx-auto rounded-3xl p-10 text-center" style={{ backgroundColor: '#213448' }}>
            <div className="text-3xl mb-3">🐾</div>
            <h3 className="text-white mb-3" style={{ fontWeight: 700, fontSize: '1.4rem' }}>¿Quieres unirte a nuestro equipo?</h3>
            <p className="text-white/70 text-sm mb-6 max-w-xl mx-auto leading-relaxed">
              Si quieres ayudar como voluntario, acogida temporal o simplemente contribuir a nuestra causa, escríbenos. Cada mano cuenta.
            </p>
            <Link
              to="/contacto"
              className="inline-flex items-center gap-2 bg-white px-7 py-3 rounded-xl text-sm transition-all hover:shadow-lg"
              style={{ fontWeight: 600, color: '#213448' }}
            >
              Contáctanos
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-start gap-4 p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#dce8ed' }}>
                <Clock className="w-6 h-6" style={{ color: '#547792' }} />
              </div>
              <div>
            ...
            <div className="flex items-start gap-4 p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#dce8ed' }}>
                <MapPin className="w-6 h-6" style={{ color: '#547792' }} />
              </div>
              <div>
                ...
                <Link to="/contacto" className="inline-flex items-center gap-1 text-sm mt-3" style={{ color: '#547792', fontWeight: 500 }}>
      ...
      <section className="py-16" style={{ backgroundColor: '#dce8ed' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-gray-900 mb-4" style={{ fontWeight: 700, fontSize: 'clamp(1.4rem, 3vw, 2rem)' }}>
            ¿Listo para adoptar?
          </h2>
