...
export default function AvisoLegal() {
  usePageMeta({
    title: 'Aviso Legal | Ayuda Animal Murcia',
    description: 'Aviso legal de la página web de Ayuda Animal Murcia, conforme a la LSSI-CE.',
    path: '/aviso-legal',
  });
        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: '#727272' }}>
          ...
          <section>
            ...
            <div className="mt-4 rounded-xl border p-4 space-y-1" style={{ backgroundColor: '#ffffff', borderColor: '#d9d9d9' }}>
              ...
              <p><strong style={{ color: '#2e2e2e' }}>CIF:</strong> G73418873</p>
              ...
              <p><strong style={{ color: '#2e2e2e' }}>Sitio web:</strong> https://www.ayudaanimalmurcia.org</p>
