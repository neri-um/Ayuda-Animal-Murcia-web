...
export default function NovedadDetail() {
  ...
  usePageMeta({
    title: novedad ? `${novedad.titulo} | Ayuda Animal Murcia` : 'Novedad no encontrada | Ayuda Animal Murcia',
    description: novedad?.resumen ?? 'Novedad de Ayuda Animal Murcia.',
    path: novedad ? `/novedades/${novedad.id}` : undefined,
    type: 'article',
  });
