...
public class SolicitudProducto {
    ...
    private LocalDateTime fechaResolucion;   // CU-20: cuando se acepta/rechaza

    @ManyToOne
    @JoinColumn(name = "gestionado_por")
    private Usuario gestionadoPor;           // CU-20: encargado que decide
	...
	public Usuario getGestionadoPor() {
		return gestionadoPor;
	}

	public void setGestionadoPor(Usuario gestionadoPor) {
