...
public class AnimalController {
	...
	public AnimalController(AnimalesUseCase animales, UsuarioRepositorioPort usuarioRepo, EntradaBlogUseCase entradas) {
	...
	@GetMapping("/{id}/blog")
	public ResponseEntity<List<EntradaBlogDTO>> entradasDeBlog(@PathVariable Long id) {
		return ResponseEntity.ok(entradas.listarPorAnimal(id).stream()
