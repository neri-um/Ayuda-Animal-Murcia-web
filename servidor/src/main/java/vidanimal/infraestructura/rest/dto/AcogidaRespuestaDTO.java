...
public class AcogidaRespuestaDTO {
	...
	private EstadoSolicitudCuestionario solicitudEstado;
	...
	public EstadoSolicitudCuestionario getSolicitudEstado() {
		return solicitudEstado;
	}

	public void setSolicitudEstado(EstadoSolicitudCuestionario solicitudEstado) {
