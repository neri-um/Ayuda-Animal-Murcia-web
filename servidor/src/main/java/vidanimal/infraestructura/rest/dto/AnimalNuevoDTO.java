...
public class AnimalNuevoDTO {
	...
	public Animal toDominio() {
		...
		animal.setCompatiblePerrosGrandes(compatiblePerrosGrandes);
		...
		animal.setPuedeVivirPiso(puedeVivirPiso);
		animal.setPuedeVivirExterior(puedeVivirExterior);
		animal.setAptoGatoUnico(aptoGatoUnico);
		animal.setNecesitaCompaneroFelino(necesitaCompaneroFelino);
		animal.setFlexibleConvivenciaFelina(flexibleConvivenciaFelina);
		animal.setAdopcionConjunta(adopcionConjunta);
		animal.setCaracter(caracter);
		return animal;
	}
