    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/vidanimal/animales/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/vidanimal/animales/*/blog").permitAll()
                .requestMatchers(HttpMethod.GET, "/vidanimal/blog").permitAll()
                .requestMatchers(HttpMethod.GET, "/vidanimal/blog/*").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/vidanimal/formularios/acogida").permitAll()
                .requestMatchers(HttpMethod.POST, "/vidanimal/adopciones").permitAll()
                .requestMatchers(HttpMethod.POST, "/vidanimal/contacto").permitAll()
                .requestMatchers(HttpMethod.POST, "/vidanimal/colaboracion").permitAll()
                .requestMatchers(HttpMethod.POST, "/vidanimal/acogidas").permitAll()
                .requestMatchers(HttpMethod.POST, "/vidanimal/acogidas/solicitudes").permitAll()
                .requestMatchers(HttpMethod.PATCH, "/vidanimal/acogidas/solicitudes/*/animal")
                ...
                .requestMatchers(HttpMethod.GET, "/vidanimal/formularios")
                    .hasAnyAuthority("VOLUNTARIO", "ENCARGADO", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/vidanimal/formularios/acogida")
                    .hasAnyAuthority("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/vidanimal/formularios/acogida/*")
                    .hasAnyAuthority("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/vidanimal/adopciones/*/animal")
                    .hasAnyAuthority("VOLUNTARIO", "ENCARGADO", "ADMIN")
